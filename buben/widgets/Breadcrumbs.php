...
class Breadcrumbs extends Widget
{
	...
	public $itemOptions = ['class' => 'btn btn-primary btn-sm rounded-s'];
	 ...
	 */
	public $activeItemTemplate = "<li class='btn btn-sm rounded-s btn-primary-outline'>{link}</li>\n";
	...
	protected function renderItem($link, $template)
	{
		...
		if (isset($link['url'])) {
			...
			$link = Html::a($label, $link['url'], array_merge($options,$this->itemOptions));
		} else {
			$link = $label;
		}
